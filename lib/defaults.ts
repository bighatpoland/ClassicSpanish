...
export const INPUT_LIBRARY: StudyMaterial[] = [
  {
    ...
    durationMin: 4,
    level: "A1",
    summary: "Krotki dialog do powtarzania i retellu z codziennej rutyny.",
  ...
  },
  {
    ...
    durationMin: 3,
    level: "A1",
    summary: "Prosby, liczby i uprzejmosc w jednym szybkim materiale.",
  ...
  },
  {
    ...
    durationMin: 5,
    level: "A1-A2",
    summary: "Mini tekst do spokojnego inputu i prostego przetwarzania na mowienie.",
...
export const SPEAK_PROMPTS: SpeakPrompt[] = [
  {
    id: "speak-rutina",
    topic: "Rutyna",
    prompt: "Opowiedz po hiszpansku, jak wyglada twoj zwykly poranek.",
    support: ["Zacznij od 'Normalmente...'", "Uzyj 'primero', 'despues', 'luego'.", "Dodaj jedna opinie."]
  },
  {
    id: "speak-lesson",
    topic: "Lekcja",
    prompt: "Jakie trzy rzeczy chcesz dzis powiedziec lektorowi?",
    support: ["Zacznij od 'Hoy quiero hablar de...'", "Dodaj jedno pytanie.", "Dodaj jedno zdanie o problemie."]
  },
  {
    id: "speak-opinion",
    topic: "Opinia",
